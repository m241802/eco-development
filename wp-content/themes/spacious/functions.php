...
function spacious_setup() {
	...
	add_image_size( 'featured-blog-large', 945, 550, true );
	add_image_size( 'featured-blog-medium', 270, 270, true );
	add_image_size( 'featured', 642, 300, true );
	add_image_size( 'featured-blog-medium-small', 230, 180, true );	
	add_image_size( 'featured-medium', 270, 180, true );
	add_image_size( 'featured-slide-small', 200, 150, true );
