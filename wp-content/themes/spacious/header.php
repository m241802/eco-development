		...
		<div id="header-text-nav-container">
			<div class="inner-wrap">
				...
				<div id="header-text-nav-wrap" class="clearfix">
						...
						?>
						<div class="socia-networks">
						    <?php $img_soc=wp_get_attachment_image_src($img_id, 'featured-slide-small');?>						   
						       <a href="<?php echo get_post_meta(182, 'vk_url', true);?>" title="ВКонтакте" ><div class="vk"></div></a>				    
						       ...
						       <!-- <a href="<?php echo get_post_meta(182, 'g+_url', true);?>" title="Google+" ><div class="google"></div></a>  -->
						</div>						
						<?php
		...
		<div class="header-post-title-container clearfix">
			<div class="inner-wrap">
				<div class="post-title-wrapper">
					...
					?>
				   	<h1 class="header-post-title-class"><a href="<?php bloginfo('url'); ?>">Главная</a><?php echo spacious_header_title(); ?></h1>
				   <?php
					}
					?>
				</div>
