...
get_header(); ?>
  ...
  <div id="primary">
    <div id="content" class="clearfix">
      ...
      query_posts('post_type=our-works&posts_per_page=12&offset='.$offset_page);
      ?>
      ...
      if ( $total > 1 )  {
           ...
           $format = get_home_url() . '/our-works/?page_nv=%#%';             
          $var=paginate_links(array(
           ...
           foreach ($var as $key => $value) {
            ...
            if($current_page>1&$i==2){        
               print_r('<a class="page-numbers" href="/our-works">1</a>');            
           }
           elseif ($current_page==2&$i==1) {
             print_r('<a class="page-numbers" href="/our-works"><</a>');
           }
           else{
           print_r($value);           
            }
